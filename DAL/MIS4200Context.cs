...
using System.Linq;
using System.Web;
using Chappel_MIS4200.Models; // This is needed to access the models
using System.Data.Entity; // this is needed to access the DbContext object
namespace Chappel_MIS4200.DAL
{
    public class MIS4200Context : DbContext // inherits from DbContext
    {
        ...
        public DbSet<Pet> Orders { get; set; }
        public DbSet<Vet> Customers { get; set; }
